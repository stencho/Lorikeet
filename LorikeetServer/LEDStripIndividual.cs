...
public unsafe class LEDStripIndividual {
    ...
    public LEDStripIndividual(byte led_count, LED color) {
        ...
        AddLEDs(led_count, color.R, color.G, color.B);
    }
...
public static unsafe class MappedLEDStripIndividual {
    private static MemoryMappedFile memory_map;
