...
namespace LorikeetUI {
    public class AutoRenderTarget {
        ...
        public XYPair size {
            get {
                if (_size == -XYPair.One) return State.WindowBounds;
                else return _size;                
        ...
        void init() {
            ...
            if (screen_pos_effect == null) screen_pos_effect = State.content.Load<Effect>("effects/render_target_screen_pos");
        ...
        public void draw_screen_pos_map() {
            ...
            screen_pos_effect.Parameters["resolution"].SetValue(State.WindowBounds.ToVector2());
